...
#' @param res the results from anova functions
#' @param main a charachter string
#' @param showLabels boolean. default to F
#' @noRd
...
#' @param data a datframe,
#' @param groups the group variabel
#' @param adjustMethod a charachter string . the adjustment method.
#' @param thresh double. the threshold for detection
#' @noRd
...
#' @param tukey.res the tukey resuts
#' @param thresh double. the threshold for detection
#' @noRd
...
#' @param res anova results
#' @param sigLvl double. singificance levels
#' @noRd
...
#' @param prefix charachter string
#' @noRd
